...
class AppModel: ObservableObject{
    var portfolio: Portfolio = Portfolio(name: "Ahmed Ashraf Fayeq", role: "iOS Developer", description: "Immensely passionate about iOS and related technologies, I am also a UI/UX enthusiast, and I love to tinker with tech", location: "Cairo, Egypt", skills: [
